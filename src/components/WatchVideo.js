...
import { YOUTUBE_COMMENT_API } from "../constant"
    ...
    return (
        <div className="flex h-[687px] overflow-auto " id="watchpage">
            <div className="w-11/12">
                <iframe className="sm:m-1 sm:rounded-2xl sm:p-1 sm:w-[880px] sm:h-4/5 min-w-screen" width={window.innerWidth} height="270px" src={src} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
