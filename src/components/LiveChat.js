...
const LiveChat = () => {
    ...
    return (showChat ? (
        <div className="w-[426px] h-fit flex">
            <button className="m-auto hover:bg-gray-200 w-11/12 rounded-full p-1 border border-slate-300" onClick={handleClick}>Show chat</button>
        </div>
    ) : (
        <div className="w-[426px] border-solid border-2 border-slate-200 h-fit rounded-2xl">
            <div className="border-b-2 px-4 py-2 border-gray-200">
                <h1 className="text-lg">Top Chat</h1>
            </div>
            <div className="mx-3 h-[500px] overflow-y-scroll flex flex-col-reverse">
                {
                        ...
                        return (
                            <div className="flex my-1" key={index}>
                                <div className="m-1 flex">
                                    ...
                                    <h1 className="mx-2">{chat?.message}</h1>
                                </div>
                            </div>
                        )
                    })
            ...
            <div className=" border-gray-100">
                ...
                <form className="px-3 py-2" onSubmit={(e) => {
                    ...
                    <input placeholder="Chat..." className="w-4/5 bg-gray-200 px-3 py-1 m-1 rounded-full" onChange={(e) => setSendChat(e.target.value)} value={sendChat} />
                    <button className="px-3 py-1 m-1 rounded-full bg-gray-200">Send</button>
                </form>
                <div className="border-t-2 border-gray-200 py-1 flex  ">
                    <button className="m-auto hover:bg-gray-200 w-11/12 rounded-full p-1" onClick={handleClick}>Hide chat</button>
                </div>
            </div>
        </div>
    ))
